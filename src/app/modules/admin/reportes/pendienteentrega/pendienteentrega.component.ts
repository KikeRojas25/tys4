...
@Component({
  ...
  templateUrl: './pendienteentrega.component.html',
  styleUrls: ['./pendienteentrega.component.css'],
   standalone: true,
      imports:[
            FormsModule,
            CommonModule,
...
clientes: SelectItem[] = [];
 estaciones: SelectItem[] = [];
  ...
  buscar() {
    ...
    var url = "http://104.36.166.65/webreports/pendienteentrega.aspx?iddistrito="
    + "&fecinicio="
    + "&fecfin="
    + "&idusuario=2"
