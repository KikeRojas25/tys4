...
import { Manifiesto, OrdenTransporteProviderRecojoResult, User } from '../../trafico/trafico.types';
import { TableModule } from 'primeng/table';
import { ButtonModule } from 'primeng/button';
import { DialogModule } from 'primeng/dialog';
import { CambiarEstadoModalComponent } from '../../trafico/vistamanifiestos/modalcambiarestado';
...
import { AsignartipooperacionRutaComponent } from '../../trafico/vistarepartidor/asignartipooperacion/asignartipooperacionruta.component';
import { ModalReasignarRepartidorComponent } from '../../trafico/vistarepartidor/modal-reasignar-repartidor.component';

@Component({
  selector: 'app-retorno-vistarepartidor',
...
export class RetornoVistarepartidorComponent implements OnInit, OnDestroy {
...
this.cols6 = [
  ...
  reloadDetalles(): void {
    this.loading = true;
    const E = RetornoVistarepartidorComponent;
