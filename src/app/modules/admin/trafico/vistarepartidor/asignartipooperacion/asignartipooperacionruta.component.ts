...
@Component({
  selector: 'app-asignartipooperacionruta',
  templateUrl: './asignartipooperacionruta.component.html',
  styleUrls: ['./asignartipooperacionruta.component.css'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class AsignartipooperacionRutaComponent implements OnInit {
  ...
  guardar() {
    ...
    if(this.model.idtipooperacion=== 123) {
      ...
      this.planningService.asignarTipoOperacionRuta(this.model ).subscribe( x=> {
        this.ref.close(x);
      })
  }
  compararDestinos() {
